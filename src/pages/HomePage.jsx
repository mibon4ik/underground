...
.stat-card { padding: 18px; border-radius: 20px; border: 1px solid var(--stroke); background: linear-gradient(180deg,rgba(216,255,71,.03),rgba(255,255,255,.01)); box-shadow: 0 22px 58px rgba(0,0,0,.32); text-align: center; }
.stat-card .n { font-size: 36px; font-weight: 1000; color: var(--accent); line-height: 1; }
.stat-card .t { font-size: 13px; color: var(--muted); margin-top: 6px; }
.grid-2 { display: grid; grid-template-columns: 1fr 1fr; gap: 14px; }
@media (max-width: 1180px) { .hero-grid { grid-template-columns: 1fr; } .grid-2 { grid-template-columns: 1fr; } }
